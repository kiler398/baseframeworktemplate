...
namespace Easyasp.Framework.Core.BaseManage.SpringBase.Domains.BaseDomain
{
	...
	public abstract class SystemApplicationBase
	{
		...
		#region 公共常量		
		public static readonly string CLASS_FULL_NAME = "Easyasp.Framework.Core.BaseManage.SpringBase.Domains.Domain.SystemApplication";
		...
		private bool _systemapplication_issystemapplication;
		#endregion
		...
		public SystemApplicationBase()
		{
			...
			_systemapplication_issystemapplication = false; 
		}
		#endregion
		...
		{
			get { return _systemapplication_issystemapplication; }
			set { _isChanged |= (_systemapplication_issystemapplication != value); _systemapplication_issystemapplication = value; }
		}
		/// <summary>
		/// 返回对象是否被改变。
		/// </summary>
		...
		public virtual void CopyValue( SystemApplicationBase obj )
		{
			...
			obj.SystemApplicationIsSystemApplication = this._systemapplication_issystemapplication;
		}
        #endregion
	}
}
