<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu2.aspx.cs" Inherits="BaseManageFramework.Web.MainPage.Menu2" meta:resourcekey="PageResource1" uiculture="auto" Theme="Default" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td height="28" background="../images/BaseFramework/Index/top-b-3-2.gif">
    <img border="0" src="../images/BaseFramework/Index/top-b-2-1-2.gif" align="left" hspace="0">
...
<script language="javascript" type="text/javascript">
    ...
    function NowShow(TopMenuName,nowno)
    {
        for(x=1;x<=TotalTopMenuCount;x++)
        {
            ...
            document.getElementById(TopMenuName + x + "i").src = "../images/BaseFramework/index/top-b-1.gif";
        ...
        document.getElementById(TopMenuName + nowno + "i").src = "../images/BaseFramework/index/top-b-2-2.gif";
    ...
    function xNowShow(iname,links)
    {
        if (ItemClickName!="")
        {
            document.getElementById(ItemClickName).style.backgroundImage = "url(../images/BaseFramework/index/top-b4-b.gif)";
            document.getElementById(ItemClickName).className = "topmenuoff2";
        }
       ItemClickName = iname;
       document.getElementById(iname).style.backgroundImage = "url(../images/BaseFramework/index/top-b4-yellow.gif)";
    ...
    function xImageOverOROut(iname,ck)
    {
        if (ItemClickName != iname)
        {
            ...
            {
                document.getElementById(iname).style.backgroundImage = "url(../images/BaseFramework/index/top-b4-b.gif)";
