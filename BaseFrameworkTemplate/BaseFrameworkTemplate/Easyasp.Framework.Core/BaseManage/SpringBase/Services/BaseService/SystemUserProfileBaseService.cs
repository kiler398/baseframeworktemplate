...
{
    public class SystemUserProfileBaseService : BaseSpringNHibernateService<SystemUserProfile>
    {
        public SystemUserProfileDao SelfDao
        {
            get
            {
                return (SystemUserProfileDao)selfDao;
            }
            set
            {
                selfDao = value;
